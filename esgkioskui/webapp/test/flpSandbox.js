		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#commgcesgkioskesgkioskui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commgcesgkioskesgkioskui-display": {
								"semanticObject": "commgcesgkioskesgkioskui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mgc.esgkiosk.esgkioskui",
									"url": sap.ui.require.toUrl("com/mgc/esgkiosk/esgkioskui")
								}
							}
						}
					}
