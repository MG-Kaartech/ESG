sap.ui.define([
    ...
    function (Controller, BarcodeScanner, Fragment, Filter, FilterOperator) {
        ...
        var Ot_Frequency,
            LocationCode;
        return Controller.extend("com.mgc.esgkiosk.esgkioskui.controller.View1", {
            onInit: function () {
            ...
            openScan: function (oEvent) {
                ...
                // BarcodeScanner.getKeepCameraScan(true);
                BarcodeScanner.scan(
                    function (mResult) {
                    ...
                    oModel1.read("/TimeSheetDetails", {
                        ...
                        success: function (odata) {
                            ...
                            if (tempdata.length === 0) {
                                ...
                                empDataPush.PayCode = "";
                                oModel.create("/TimeSheetDetails",
                                    empDataPush,
                                    {
                                        success: function (odata) {
            ...
            punchOutTime: function (oEvent) {
                ...
                oModel2.read("/TimeSheetDetails", {
                    ...
                    success: function (oData) {
                        ...
                        oModel3.update("/TimeSheetDetails(ID=" + timeData[lastIndex].ID + ",AppName='" + timeData[lastIndex].AppName + "',Date='" + d + "')",
                            {
                                OutTime: out,
